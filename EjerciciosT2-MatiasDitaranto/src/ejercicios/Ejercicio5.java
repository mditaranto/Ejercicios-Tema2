...
public class Ejercicio5 {
	...
	public static void main(String[] args) {
		...
		/*
		 * Con un ternario, si el numero es positivo se queda con su valor, en caso
		 * contrario se multiplica por -1 obteniendo un valor en positivo
		 */
		num = num > 0 ? num : num * -1;

		// Se ofrece al usuario su numero en valor absoluto
		System.out.println("El numero introducido en valor absoluto es: " + (int) num);
